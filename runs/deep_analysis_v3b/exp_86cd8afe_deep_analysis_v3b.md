...
| 排名 | 窗口ID | 收益 | MDD | 回撤形态 |
|------|--------|------|-----|----------|
| 1 | exp_86cd8afe_20d_0 |    4.15% |   0.5% | fast_recovery |
| 2 | exp_86cd8afe_20d_1 |    4.59% |   0.5% | fast_recovery |
...
replay = [r for r in replays if r.run_id == 'exp_86cd8afe'][0]
