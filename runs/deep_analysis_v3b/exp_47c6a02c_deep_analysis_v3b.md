...
| 排名 | 窗口ID | 收益 | MDD | 回撤形态 |
|------|--------|------|-----|----------|
| 1 | exp_47c6a02c_20d_0 |    0.00% |   0.0% | sharp |
| 2 | exp_47c6a02c_20d_1 |    0.00% |   0.0% | sharp |
| 3 | exp_47c6a02c_20d_2 |    0.00% |   0.0% | sharp |
...
replay = [r for r in replays if r.run_id == 'exp_47c6a02c'][0]
